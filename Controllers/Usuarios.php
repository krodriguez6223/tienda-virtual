					...
					if($idUsuario == 0)
					{
						...
						if($_SESSION['permisosMod']['w']){
							...
							if($request_user != 'exist'){
									...
									$arrResponse = array('status' => true, 'idproducto' => $request_user, 'msg' => 'Datos guardados correctamente.');
													
							}else if($request_user == 'exist'){
													
									$arrResponse = array('status' => false, 'msg' => '¡Atención! ya existe un Usuario con el correo ingresado.');
