            ...
            <table class="table table-striped table-sm">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?= base_url() ?>/pedidos/orden/<?= $pedido['idpedido'] ?>" target="_blank"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                  
                  <td><a href="https://wa.me/+593<?= $pedido['telefono'] ?>" target="_blank"><i class="fab fa-whatsapp" aria-hidden="true"></i></a></td>
