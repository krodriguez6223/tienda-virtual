			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						...
						<?php if($arrProducto['precio_desc'] > 0){?>
						
						    <span class="mtext-106 cl2"><?= SMONEY.formatMoney($arrProducto['precio_desc']); ?></span>
							
							<?php }else{?>
								
								<span class="mtext-106 cl2"><?= SMONEY.formatMoney($arrProducto['precio']); ?></span>
