...
$colores= $data['color'];
$presentaciones = $data['presentacion'];


if ($data['productosFiltrar']) {
	$arrProductos = $data['productosFiltrar'];
}else{
...
<div class="bg0 m-t-23 p-b-140">
	<div class="container">
		...
		<form id="formularioSearch" method="POST" name="formularioSearch">
				<div class="flex-w flex-c-m m-tb-10">
					...
					<div class="m-2">
						...
						<select class="form-control "id="catColor" name="catColor">
                              <option value="">--seleccione--</option>   
							<?php foreach ($colores as $key => $color){ ?>
							<option value="<?php  echo $color['idcategoria'] ?>"><?php  echo $color['nombre'] ?></option>
							<<?php } ?>
					...
					<div class="m-2">
						...
						<select class="form-control "id="catPresen" name="catPresen">
                             <option value="">--seleccione--</option>
							<?php foreach ($presentaciones as $key => $presentacion){ ?>
							<option value="<?php  echo $presentacion['idcategoria'] ?>"><?php  echo $presentacion['nombre'] ?></option>
							<<?php } ?>
		...
		<div class="row isotope-grid">
			...
			?>
					<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
						<?php if ($arrProductos[$p]['precio_desc'] > 0) { ?>

							<span class="ofertaPorcentaje"><?php echo $arrProductos[$p]['porcentaje_desc'] ?>%</span>
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									...
									<?php if ($arrProductos[$p]['precio_desc'] > 0) { ?>
										...
										<span class="precioProdu">
											<?= SMONEY . formatMoney($arrProductos[$p]['precio']); ?>

										</span><span class="precioDesc">Oferta: <?= SMONEY . formatMoney($arrProductos[$p]['precio_desc']); ?></span>
