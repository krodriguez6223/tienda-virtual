    ...
    <div class="col-md-12">
      <div class="tile">
        ...
        <section id="sPedido" class="invoice">
          <div class="row mb-4">
            <div class="col-6">
              <h2 class="page-header"><img class="logo-orden" src="<?= media(); ?>/tienda/images/logo.png" ></h2>
            </div>
            <div class="col-6">
          ...
          <div class="row invoice-info">
            ...
            <div class="col-4">
              <address><strong><?= $cliente['nombres'].' '.$cliente['apellidos'] ?></strong><br>
                Dirección: <?= $orden['direccion_envio']; ?><br>
            ...
            <div class="col-12 table-responsive">
              <table class="table table-striped">
                    ...
                    <?php 
                        ...
                        if(count($detalle) > 0){
                            foreach ($detalle as $producto) {
                                $subtotal += $producto['cantidad'] * $producto['precio']/1.12;
                                $iva = $subtotal * 0.12;
                     ?>
                  <tr>
                ...
                <tfoot>
                    ...
                    <tr>
                        <th colspan="3" class="text-right">Iva(12%):</th>
                        <td class="text-right"><?= SMONEY.' '. formatMoney($iva) ?></td>
                    </tr>
                    <tr>
