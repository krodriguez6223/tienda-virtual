      ...
      <ul class="app-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/colores"><i class="icon fa fa-circle-o"></i> Cat. colores</a></li>
                <?php } ?>
                <?php if(!empty($_SESSION['permisos'][6]['r'])){ ?>
                <li><a class="treeview-item" href="<?= base_url(); ?>/presentacion"><i class="icon fa fa-circle-o"></i> Cat. presentación</a></li>
                <?php } ?>
            </ul>
        </li>
        <?php } ?>
        ...
        <li>
         ...
         <?php if(!empty($_SESSION['permisos'][MDPORTADA]['r'])){ ?>
        <li>
            <a class="app-menu__item" href="<?= base_url(); ?>/portadas">
            <i class="app-menu__icon fa fa-picture-o" aria-hidden="true"></i>
                <span class="app-menu__label">Portada</span>
            </a>
        </li>
         <?php } ?>
