<!-- Modal -->
<div class="modal fade" id="modalFormCategoriasPre" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog " >
    <div class="modal-content">
      ...
      <div class="modal-body">
            <form id="formCategoriaPre" name="formCategoriaPre" class="form-horizontal">
              ...
              <div class="row">
                <div class="col-md-12">
                    <div class="form-group">
                      <label class="control-label">Nombre de presentación<span class="required">*</span></label>
