...
foreach ($_SESSION['arrCarrito'] as $producto) {
	...
	if($producto['precioDesc'] > 0){
		...
		$subtotal += $producto['precioDesc'] * $producto['cantidad']/1.12;
	}else{
	   
    	$subtotal += $producto['precio'] * $producto['cantidad']/1.12;
	}
}
$total = $subtotal + COSTOENVIO;
$iva = $subtotal * 0.12;

$TotlaConIva =  $total + $iva;
					...
					?>
						<div>
							...
							<div class="bor8 bg0 m-b-12">
								<input id="txtDireccion" class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="state" placeholder="Provincia">
							</div>
						  	...
						  	<form id="formRegister"> 
						 		...
						 		<div class="row">
									...
									<div class="col col-md-6 form-group">
										...
										<p>¡Atención!. 
										Revisa tu bandeja de entrada en "correo no deseado", al registrarte te mostrará una clave tempora de acceso, la podras cambiar desde el perfil de tu cuenta una vez iniciado sesión</p>
						 		</div>
					...
					<div class="flex-w flex-t p-t-27 p-b-33">
						...
						<div class="size-209 p-t-1">
							<span id="totalCompra" class="mtext-110 cl2">
								<?= SMONEY.formatMoney($TotlaConIva) ?>
							</span>
						</div>
					</div>
					<hr>
